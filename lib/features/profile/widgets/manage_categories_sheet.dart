...
class _ManageCategoriesSheetState extends ConsumerState<ManageCategoriesSheet> {
  ...
  Future<void> _addCategory() async {
    ...
    try {
      await _categoriesService.addCategory(Category(name: name, createdAt: DateTime.now()));
                          ...
                          Expanded(
                            child: isEditing
                                ? TextInput(
                                    ...
                                    textInputAction: TextInputAction.done,
                                    onFieldSubmitted: (_) => _updateCategory(category),
                                    autofocus: true,
                                  )
                                : Text(
                                    category.name,
                          ...
                          if (!isEditing) ...[
                            IconButton(
                              onPressed: () {
                                ...
                                setState(() => _editingCategoryId = category.id);
                              },
                              icon: FaIcon(
